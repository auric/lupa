...
export class SymbolExtractor {
   ...
   */
  async getFileSymbols(fileUri: vscode.Uri): Promise<vscode.DocumentSymbol[] | vscode.SymbolInformation[]> {
    try {
   ...
   */
  async getPathStat(targetPath: string): Promise<vscode.FileStat | undefined> {
    try {
      const targetUri = vscode.Uri.file(targetPath);
