...
describe('FindUsagesTool', () => {
    ...
    describe('Tool Configuration', () => {
        it('should have correct name and description', () => {
            ...
            expect(findUsagesTool.description).toContain(
        ...
        it('should generate correct VS Code tool configuration', () => {
            ...
            expect(vscodeTool.description).toContain(
                'Find all places where a symbol is used'
            );
    ...
    describe('execute method', () => {
        ...
        it('should handle document reading errors for references', async () => {
            ...
            const mockReferences = [
                {
                    uri: {
                        toString: () => 'file:///test/workspace/src/error.ts',
                        fsPath: '/test/workspace/src/error.ts',
                    },
                    range: {
