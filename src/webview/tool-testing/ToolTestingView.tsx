...
import type { ToolTestingViewProps, ToolInfo } from '../types/toolTestingTypes';
...
const ToolTestingView: React.FC<ToolTestingViewProps> = ({
    ...
    const [activeTab, setActiveTab] = useState<'parameters' | 'results'>(
        'parameters'
    );
    ...
    return (
        <div
            className={`flex h-screen w-full bg-background text-foreground ${isDarkTheme ? 'dark' : ''}`}
        >
                ...
                {layout.shouldStack ? (
                    ...
                    >
                        ...
                        <div className="flex-1 overflow-hidden relative">
                            <TabsContent
                                value="parameters"
                                className="absolute inset-0 m-0 p-0 border-none data-[state=inactive]:hidden"
                            >
                                <ParameterInputPanel
