    ...
    return (
        <div className="flex flex-col h-full bg-transparent">
            ...
            <div className="p-3 border-b border-border bg-transparent">
                <h2 className="text-[11px] font-bold text-muted-foreground uppercase tracking-wider mb-2 px-1">
                    Tools
                </h2>
...
const ToolItem: React.FC<ToolItemProps> = ({ tool, isSelected, onSelect }) => {
    const handleClick = () => {
        onSelect(tool.name);
    };
      ...
      `}
        ...
        >
            ...
            <div className="flex items-center gap-1 shrink-0">
                ...
                {tool.usageCount > 0 && (
                    <span className="text-[10px] bg-muted text-muted-foreground px-1 rounded-sm">
                        {tool.usageCount}
                    </span>
                )}
            </div>
